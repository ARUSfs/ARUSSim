...
bool arussim_msgs__msg__four_wheel_drive__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("arussim_msgs.msg._four_wheel_drive.FourWheelDrive", full_classname_dest, 49) == 0);
  }
  arussim_msgs__msg__FourWheelDrive * ros_message = _ros_message;
  {  // front_right
...
{
  /* NOTE(esteve): Call constructor of FourWheelDrive */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("arussim_msgs.msg._four_wheel_drive");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "FourWheelDrive");
