...
class VehicleDynamics
{
    public:
        ...
        void update_simulation(double& x, double& y, double& yaw, double& vx, 
                                ...
                                double kMass, double kWheelBase);
    ...
    private:
        ...
        void calculate_dynamics(double vx, double yaw, double input_delta, double input_acc, double kMass, double kWheelBase);
        void integrate_dynamics(double& x, double& y, double& yaw, double& vx, double dt);
        double calculate_fx(double vx, double input_acc, double kMass);
};