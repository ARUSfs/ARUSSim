...
#include "arussim_msgs/msg/detail/trajectory__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const arussim_msgs::msg::PointXY &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  arussim_msgs::msg::PointXY &);
size_t get_serialized_size(
  const arussim_msgs::msg::PointXY &,
  size_t current_alignment);
size_t
max_serialized_size_PointXY(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment);
}  // namespace typesupport_fastrtps_cpp
...
cdr_serialize(
  const arussim_msgs::msg::Trajectory & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  {
    cdr << ros_message.speed_profile;
  }
  // Member: acc_profile
  {
    cdr << ros_message.acc_profile;
  }
  return true;
}
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  arussim_msgs::msg::Trajectory & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  // Member: speed_profile
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    size_t item_size = sizeof(ros_message.speed_profile[0]);
    current_alignment += array_size * item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // Member: acc_profile
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    size_t item_size = sizeof(ros_message.acc_profile[0]);
    current_alignment += array_size * item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  ...
  size_t current_alignment)
{
  ...
  // Member: points
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        arussim_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_PointXY(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = arussim_msgs::msg::Trajectory;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const arussim_msgs::msg::Trajectory *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<arussim_msgs::msg::Trajectory *>(
    untyped_ros_message);
...
{
  return &arussim_msgs::msg::typesupport_fastrtps_cpp::_Trajectory__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, arussim_msgs, msg, Trajectory)() {
  return &arussim_msgs::msg::typesupport_fastrtps_cpp::_Trajectory__handle;
}
