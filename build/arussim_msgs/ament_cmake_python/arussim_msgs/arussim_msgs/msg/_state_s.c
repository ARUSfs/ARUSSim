...
bool arussim_msgs__msg__state__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("arussim_msgs.msg._state.State", full_classname_dest, 29) == 0);
  }
  arussim_msgs__msg__State * ros_message = _ros_message;
  {  // header
  ...
  {  // wheel_speeds
    ...
    if (!arussim_msgs__msg__four_wheel_drive__convert_from_py(field, &ros_message->wheel_speeds)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
  ...
  {  // torque
    ...
    if (!arussim_msgs__msg__four_wheel_drive__convert_from_py(field, &ros_message->torque)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
...
PyObject * arussim_msgs__msg__state__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("arussim_msgs.msg._state");
  ...
  {  // wheel_speeds
    PyObject * field = NULL;
    field = arussim_msgs__msg__four_wheel_drive__convert_to_py(&ros_message->wheel_speeds);
    if (!field) {
      return NULL;
    }
    {
      int rc = PyObject_SetAttrString(_pymessage, "wheel_speeds", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // torque
    PyObject * field = NULL;
    field = arussim_msgs__msg__four_wheel_drive__convert_to_py(&ros_message->torque);
    if (!field) {
      return NULL;
    }
    {
