...
static const _FourWheelDrive_type_support_symbol_names_t _FourWheelDrive_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, arussim_msgs, msg, FourWheelDrive)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, arussim_msgs, msg, FourWheelDrive)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, arussim_msgs, msg, FourWheelDrive)() {
  return &::arussim_msgs::msg::rosidl_typesupport_c::FourWheelDrive_message_type_support_handle;
}
