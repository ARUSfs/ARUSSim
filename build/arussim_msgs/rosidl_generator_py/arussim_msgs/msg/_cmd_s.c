...
bool arussim_msgs__msg__cmd__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("arussim_msgs.msg._cmd.Cmd", full_classname_dest, 25) == 0);
  }
  arussim_msgs__msg__Cmd * ros_message = _ros_message;
  {  // header
  ...
  {  // target_r
    PyObject * field = PyObject_GetAttrString(_pymsg, "target_r");
    if (!field) {
      return false;
    }
    assert(PyFloat_Check(field));
    ros_message->target_r = (float)PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
...
PyObject * arussim_msgs__msg__cmd__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("arussim_msgs.msg._cmd");
  ...
  {  // target_r
    PyObject * field = NULL;
    field = PyFloat_FromDouble(ros_message->target_r);
    {
      int rc = PyObject_SetAttrString(_pymessage, "target_r", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
