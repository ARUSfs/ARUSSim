...
#include "arussim_msgs/msg/detail/state__rosidl_typesupport_fastrtps_c.h"
...
#include "arussim_msgs/msg/detail/four_wheel_drive__functions.h"  // torque, wheel_speeds
...
using _State__ros_msg_type = arussim_msgs__msg__State;
...
static uint32_t _State__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_arussim_msgs__msg__State(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = arussim_msgs__msg__State;
    is_plain =
      (
...
static size_t _State__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_arussim_msgs__msg__State(
